    ...
    <div className="d-flex flex-column centered w-100">
      <div className="card cardPrimary px-3 w-100">
        <div className="card-header bg-transparent d-flex align-items-center justify-content-between">
          ...
          <button type="button" className="btn btn-outline-secondary fs14" onClick={() => setEditUserPassword(true)}>
      ...
      {editUserPassword && <EditUserPasswordModal onClose={() => setEditUserPassword(false)} />}
    </div>
  );
}
